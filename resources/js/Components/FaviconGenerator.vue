<template>
    <div>
        ...
        <ui-modal
            :open="isOpen"
            @dismissed="isOpen = false"
        >
            <div class="p-4 rounded-lg flex items-center flex-col">
                <h2 class="text-xl font-medium">Generating Favicons</h2>
                <div role="status" class="mt-4">
                    <svg aria-hidden="true" class="w-8 h-8 mr-2 px-6 py-6 animate-spin" viewBox="0 0 100 101" style="color: #eef2f6" fill="#2D9EFC" xmlns="http://www.w3.org/2000/svg">
